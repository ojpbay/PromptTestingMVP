...
export class PromptTestingApiService {
  ...
  async getPromptContext(id: string): Promise<{promptId: string, content: string}> {
  ...
  async executeTest(id: string, context: string, scope: ScopeSelection): Promise<{testId: string, status: string}> {
